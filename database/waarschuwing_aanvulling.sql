CREATE TABLE bereikbaarheidskaart.waarschuwing_aanvulling (
...
CREATE INDEX sidx_waarschuwing_aanvulling_geom ON bereikbaarheidskaart.waarschuwing_aanvulling USING gist (geom);