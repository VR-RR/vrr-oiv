CREATE TABLE bereikbaarheidskaart.noodvoorziening_aanvulling (
...
CREATE INDEX sidx_noodvoorziening_aanvulling_geom ON bereikbaarheidskaart.noodvoorziening_aanvulling USING gist (geom);