CREATE TABLE bereikbaarheidskaart.redding_mens_aanvulling (
...
CREATE INDEX sidx_redding_mens_aanvulling_geom ON bereikbaarheidskaart.redding_mens_aanvulling USING gist (geom);