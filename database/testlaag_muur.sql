CREATE TABLE bereikbaarheidskaart.muur_test_linestring (
...
CREATE INDEX sidx_muur_test_linestring_geom ON bereikbaarheidskaart.muur_test_linestring USING gist (geom);