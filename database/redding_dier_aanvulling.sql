CREATE TABLE bereikbaarheidskaart.redding_dier_aanvulling (
...
CREATE INDEX sidx_redding_dier_aanvulling_geom ON bereikbaarheidskaart.redding_dier_aanvulling USING gist (geom);